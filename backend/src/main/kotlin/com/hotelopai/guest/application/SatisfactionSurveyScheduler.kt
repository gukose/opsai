...
@Component @Profile("local","prod") class SatisfactionSurveyScheduler(private val surveys:SatisfactionSurveyService,private val runner:DistributedScheduledJobRunner,@Value("\${ops.ai.guest.survey.enabled:false}") private val enabled:Boolean){
