...
object PermissionCodes {
    ...
    const val HOUSEKEEPING_OPERATIONS = "HOUSEKEEPING_OPERATIONS"
    const val HOUSEKEEPING_INSPECTION = "HOUSEKEEPING_INSPECTION"
    const val INVENTORY_OPERATIONS = "INVENTORY_OPERATIONS"
    const val MINIBAR_OPERATIONS = "MINIBAR_OPERATIONS"
    const val DAMAGE_REVIEW = "DAMAGE_REVIEW"
    const val EMPLOYEE_OPERATIONS = "EMPLOYEE_OPERATIONS"
    const val SHIFT_OPERATIONS = "SHIFT_OPERATIONS"
    const val SERVICE_RECOVERY_OPERATIONS = "SERVICE_RECOVERY_OPERATIONS"
    const val MANAGER_REPORTING = "MANAGER_REPORTING"
    const val BILLING_REPORTS = "BILLING_REPORTS"
    const val GAMIFICATION_VIEW = "GAMIFICATION_VIEW"
    const val GUEST_MESSAGING_OPERATIONS = "GUEST_MESSAGING_OPERATIONS"
}
...
object PermissionExpressions {
    ...
    const val HOUSEKEEPING_OPERATIONS = "@permissionGuard.hasAnyPermission('${PermissionCodes.HOUSEKEEPING_OPERATIONS}')"
    const val HOUSEKEEPING_INSPECTION = "@permissionGuard.hasAnyPermission('${PermissionCodes.HOUSEKEEPING_INSPECTION}')"
    const val INVENTORY_OPERATIONS = "@permissionGuard.hasAnyPermission('${PermissionCodes.INVENTORY_OPERATIONS}')"
    const val MINIBAR_OPERATIONS = "@permissionGuard.hasAnyPermission('${PermissionCodes.MINIBAR_OPERATIONS}')"
    const val DAMAGE_REVIEW = "@permissionGuard.hasAnyPermission('${PermissionCodes.DAMAGE_REVIEW}')"
    const val EMPLOYEE_OPERATIONS = "@permissionGuard.hasAnyPermission('${PermissionCodes.EMPLOYEE_OPERATIONS}')"
    const val SHIFT_OPERATIONS = "@permissionGuard.hasAnyPermission('${PermissionCodes.SHIFT_OPERATIONS}')"
    const val SERVICE_RECOVERY_OPERATIONS = "@permissionGuard.hasAnyPermission('${PermissionCodes.SERVICE_RECOVERY_OPERATIONS}')"
    const val MANAGER_REPORTING = "@permissionGuard.hasAnyPermission('${PermissionCodes.MANAGER_REPORTING}')"
    const val BILLING_REPORTS = "@permissionGuard.hasAnyPermission('${PermissionCodes.BILLING_REPORTS}')"
    const val GAMIFICATION_VIEW = "@permissionGuard.hasAnyPermission('${PermissionCodes.GAMIFICATION_VIEW}')"
    const val GUEST_MESSAGING_OPERATIONS = "@permissionGuard.hasAnyPermission('${PermissionCodes.GUEST_MESSAGING_OPERATIONS}')"
}
